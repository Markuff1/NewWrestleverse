...
// ------- A ---------
        { src: "/Images/Roster/Abyss.png", name: "Abyss", gender: "Man", tag: "R", champion:""},
        ...
        { src: "/Images/Roster/AkiraTozawa.png", name: "Akira Tozawa", gender: "Man", tag: "R" , champion:""},
        { src: "/Images/Roster/AlbaFyre.png", name: "Alba Fyre", gender: "Women", tag: "SD" , champion:""},
        { src: "/Images/Roster/AleisterBlack.png", name: "Aleister Black", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/AlexShelley.png", name: "Alex Shelley", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/AlexaBliss.png", name: "Alexa Bliss", gender: "Women", tag: "SD" , champion:"WWH"},
        { src: "/Images/Roster/Andrade.png", name: "Andrade", gender: "Man", tag: "A" , champion:""},
        { src: "/Images/Roster/AndreChase.png", name: "Andre Chase", gender: "Man", tag: "SD" , champion:""},
        ...
        { src: "/Images/Roster/ApolloCrews.png", name: "Apollo Crews", gender: "Man", tag: "SD" , champion:""},
        ...
        { src: "/Images/Roster/AustinTheory.png", name: "Austin Theory", gender: "Man", tag: "SD" , champion:""},
 ...
 // ------- B ---------
        ...
        { src: "/Images/Roster/BigE.png", name: "Big E", gender: "Man", tag: "SD" , champion:""},
        ...
        { src: "/Images/Roster/BubbaRayDudley.png", name: "Bubba Ray Dudley", gender: "Man", tag: "R" , champion:""},
 ...
 // ------- C ---------
        ...
        { src: "/Images/Roster/CandiceLeRae.png", name: "Candice LeRae", gender: "Women", tag: "SD" , champion:""},
        ...
        { src: "/Images/Roster/CharlotteFlair.png", name: "Charlotte Flair", gender: "Women", tag: "R" , champion:""},
        { src: "/Images/Roster/ChelseaGreen.png", name: "Chelsea Green", gender: "Women", tag: "R" , champion:""},
        { src: "/Images/Roster/ChrisSabin.png", name: "Chris Sabin", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/Chyna.png", name: "Chyna", gender: "Women", tag: "L" , champion:""},
        { src: "/Images/Roster/CodyRhodes.png", name: "Cody Rhodes", gender: "Man", tag: "R" , champion:""},
        { src: "/Images/Roster/CoraJade.png", name: "Cora Jade", gender: "Women", tag: "A" , champion:""},
        { src: "/Images/Roster/CruzDelToro.png", name: "Cruz Del Toro", gender: "Man", tag: "R" , champion:""},

 // ------- D ---------

        { src: "/Images/Roster/D-VonDudley.png", name: "D-Von Dudley", gender: "Man", tag: "R" , champion:""},
        ...
        { src: "/Images/Roster/DamianPriest.png", name: "Damian Priest", gender: "Man", tag: "R" , champion:""},
 ...
 // ------- E ---------
        ...
        { src: "/Images/Roster/Erik.png", name: "Erik", gender: "Man", tag: "R" , champion:""},
        { src: "/Images/Roster/EthanPage.png", name: "Ethan Page", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/EveTorres.png", name: "Eve Torres", gender: "Women", tag: "R" , champion:""},

 // ------- F ---------

        { src: "/Images/Roster/Faarooq.png", name: "Faarooq", gender: "Man", tag: "L" , champion:""},
        { src: "/Images/Roster/FallonHenley.png", name: "Fallon Henley", gender: "Women", tag: "SD" , champion:""},
 ...
 // ------- G ---------
        ...
        { src: "/Images/Roster/Giulia.png", name: "Giulia", gender: "Women", tag: "SD" , champion:""},
        { src: "/Images/Roster/Goldberg.png", name: "Goldberg", gender: "Man", tag: "U" , champion:""},
        { src: "/Images/Roster/GraysonWaller.png", name: "Grayson Waller", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/Gunther.png", name: "Gunther", gender: "Man", tag: "SD" , champion:""},
...
// ------- I ---------       
        ...
        { src: "/Images/Roster/Ivar.png", name: "Ivar", gender: "Man", tag: "R" , champion:""},
 ...
 // ------- J ---------
        ...
        { src: "/Images/Roster/JDMcdonagh.png", name: "JD Mcdonagh", gender: "Man", tag: "R" , champion:""},
        ...
        { src: "/Images/Roster/JadeCargill.png", name: "Jade Cargill", gender: "Women", tag: "SD" , champion:""},
        ...
        { src: "/Images/Roster/JeyUso.png", name: "Jey Uso", gender: "Man", tag: "SD" , champion:""},
        ...
        { src: "/Images/Roster/JoaquinWilde.png", name: "Joaquin Wilde", gender: "Man", tag: "R" , champion:""},
        ...
        { src: "/Images/Roster/JohnCena.png", name: "John Cena", gender: "Man", tag: "R" , champion:""},
        { src: "/Images/Roster/JohnnyGargano.png", name: "Johnny Gargano", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/JordynneGrace.png", name: "Jordynne Grace", gender: "Women", tag: "R" , champion:""},
 ...
 // ------- K ---------
        ...
        { src: "/Images/Roster/Kane.png", name: "Kane", gender: "Man", tag: "R" , champion:""},
 ...
 // ------- L ---------
        ...
        { src: "/Images/Roster/LexisKing.png", name: "Lexis King", gender: "Man", tag: "R" , champion:""},
        { src: "/Images/Roster/Lita.png", name: "Lita", gender: "Women", tag: "SD" , champion:""},
        { src: "/Images/Roster/LivMorgan.png", name: "Liv Morgan", gender: "Women", tag: "R" , champion:""},
        ...
        { src: "/Images/Roster/LudwigKaiser.png", name: "Ludwig Kaiser", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/LukeGallows.png", name: "Luke Gallows", gender: "Man", tag: "A" , champion:""},
        { src: "/Images/Roster/LyraValkyria.png", name: "Lyra Valkyria", gender: "Women", tag: "R" , champion:""},
 ...
 // ------- M ---------
        ...
        { src: "/Images/Roster/MaxxineDupri.png", name: "Maxxine Dupri", gender: "Women", tag: "R" , champion:""},
        { src: "/Images/Roster/MichelleMcCool.png", name: "Michelle McCool", gender: "Women", tag: "R" , champion:""},
        { src: "/Images/Roster/Michin.png", name: "Michin", gender: "Women", tag: "SD" , champion:""},
 ...
 // ------- N ---------
        ...
        { src: "/Images/Roster/NiaJax.png", name: "Nia Jax", gender: "Women", tag: "SD" , champion:""},
 ...
 // ------- O ---------
        ...
        { src: "/Images/Roster/ObaFemi.png", name: "Oba Femi", gender: "Man", tag: "R" , champion:""},
 ...
 // ------- R ---------
        ...
        { src: "/Images/Roster/RandyOrton.png", name: "Randy Orton", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/RaquelRodriguez.png", name: "Raquel Rodriguez", gender: "Women", tag: "R" , champion:"WUC"},
        ...
        { src: "/Images/Roster/RobVanDam.png", name: "Rob Van Dam", gender: "Man", tag: "R" , champion:""},
        { src: "/Images/Roster/RoddyPiper.png", name: "Roddy Piper", gender: "Man", tag: "L" , champion:""},
        { src: "/Images/Roster/RomanReigns.png", name: "Roman Reigns", gender: "Man", tag: "R" , champion:"UC"},
 ...
 // ------- S ---------
        ...
        { src: "/Images/Roster/SamiZayn.png", name: "Sami Zayn", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/Sandman.png", name: "Sandman", gender: "Man", tag: "L" , champion:""},
        { src: "/Images/Roster/SantosEscobar.png", name: "Santos Escobar", gender: "Man", tag: "SD" , champion:""},
        ...
        { src: "/Images/Roster/Shotzi.png", name: "Shotzi", gender: "Women", tag: "SD" , champion:""},
        { src: "/Images/Roster/SolRuca.png", name: "Sol Ruca", gender: "Women", tag: "R" , champion:""},
        { src: "/Images/Roster/SoloSikoa.png", name: "Solo Sikoa", gender: "Man", tag: "R" , champion:""},
 ...
 // ------- T ---------
        ...
        { src: "/Images/Roster/TatumPaxley.png", name: "Tatum Paxley", gender: "Women", tag: "R" , champion:""},
        ...
        { src: "/Images/Roster/TheFiend.png", name: "The Fiend", gender: "Man", tag: "R" , champion:""},
        { src: "/Images/Roster/TheGreatKhali.png", name: "The Great Khali", gender: "Man", tag: "R" , champion:""},
        ...
        { src: "/Images/Roster/TheMiz.png", name: "The Miz", gender: "Man", tag: "SD" , champion:""},
        ...
        { src: "/Images/Roster/TommasoCiampa.png", name: "Tommaso Ciampa", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/TongaLoa.png", name: "Tonga Loa", gender: "Man", tag: "R" , champion:""},
        { src: "/Images/Roster/TonyD'Angelo.png", name: "Tony D'Angelo", gender: "Man", tag: "U" , champion:""},
        { src: "/Images/Roster/TrickWilliams.png", name: "Trick Williams", gender: "Man", tag: "R" , champion:""},
        ...
        { src: "/Images/Roster/TylerBate.png", name: "Tyler Bate", gender: "Man", tag: "SD" , champion:""},
        { src: "/Images/Roster/TylerBreeze.png", name: "Tyler Breeze", gender: "Man", tag: "SD" , champion:""},
 ...
 // ------- Z ---------
       ...
       { src: "/Images/Roster/ZelinaVega.png", name: "ZelinaVega", gender: "Women", tag: "R" , champion:""},
       { src: "/Images/Roster/ZoeyStark.png", name: "Zoey Stark", gender: "Women", tag: "R" , champion:""},
  ],
  RAW: [],
  SMACKDOWN: [],
  Legend: [],
  ...
  Women: [],
  "Tag Teams": [
    { src: "/Images/Roster/TagTeam/AlphaAcadamy.png", name: "Alpha Acadamy", tag: "R", champion:""},
    ...
    { src: "/Images/Roster/TagTeam/AOP.png", name: "AOP", tag: "R", champion:""},
    { src: "/Images/Roster/TagTeam/ChaseU.png", name: "Chase U", tag: "SD", champion:""},
    { src: "/Images/Roster/TagTeam/DIY.png", name: "DIY", tag: "SD", champion:""},
    { src: "/Images/Roster/TagTeam/DudleyBoys.png", name: "Dudley Boys", tag: "R", champion:"RAWTT"},
    { src: "/Images/Roster/TagTeam/Gallus.png", name: "Gallus", tag: "SD", champion:""},
    ...
    { src: "/Images/Roster/TagTeam/OC.png", name: "OC", tag: "SD", champion:""},
    ...
    { src: "/Images/Roster/TagTeam/Theory&Waller.png", name: "Theory & Waller", tag: "SD", champion:""},
    { src: "/Images/Roster/TagTeam/VikingRaiders.png", name: "Viking Raiders", tag: "R", champion:""},
