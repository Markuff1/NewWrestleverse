...
const MMITB: React.FC = () => {
  ...
  const handleAdd = async () => {
    if (form.name && form.eventWon && form.successful) {
      const dataToAdd = {
        ...form,
        reignLength: Number(form.reignLength),
      };
  ...
  const handleSave = async (id: string) => {
    ...
    const dataToUpdate = {
      ...editData,
      reignLength: Number(editData.reignLength),
    };
    ...
    setEntries(
      entries.map((entry) =>
        entry.id === id ? { id, ...dataToUpdate } : entry
      )
    );
      ...
      <div className="ChampionshipBackground">
        <div className="MITBContainer">
          ...
          <div className="InputContainerChamp">
            ...
            <input
              type="text"
              placeholder="Event Won"
              value={form.eventWon}
              onChange={(e) =>
                setForm({ ...form, eventWon: e.target.value })
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                setForm({ ...form, eventCashed: e.target.value })
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                setForm({ ...form, dateCashed: e.target.value })
              }
            />

            <input
              type="number"
              placeholder="Reign Length (Weeks)"
              value={form.reignLength}
              onChange={(e) =>
                setForm({ ...form, reignLength: e.target.value })
              }
            />
            ...
            <select
              ...
              onChange={(e) =>
                setForm({ ...form, successful: e.target.value })
              }
            >
              ...
              {entries.map((entry) =>
                editingId === entry.id ? (
                  <tr key={entry.id} className="edit-row">
                    ...
                    <td>
                      <input
                        className="editeventwon"
                        value={editData.eventWon}
                        onChange={(e) =>
                          setEditData({
                            ...editData,
                            eventWon: e.target.value,
                          })
                        }
                      />
                    </td>
                    ...
                    <td>
                      <input
                        className="editreign"
                        value={editData.reignLength}
                        onChange={(e) =>
                          setEditData({
                            ...editData,
                            reignLength: e.target.value,
                          })
                        }
                      />
                    </td>
